...
import { createOtp, forgotPassword, login, logout, register, resetStatus, verifyOtp } from '~store/slices/authSlice';
...
export const useAuth = () => {
  ...
  const sendForgotPassword = (email: string) => dispatch(forgotPassword(email));
